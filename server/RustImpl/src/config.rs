...
pub fn build_factory(tui: Rc<Tui>) -> Rc<RefCell<Factory>> {
    FactoryConfig {
        ...
        backups: vec![(label("Glow Flower"), 16), (label("Red Dye"), 16)],
        fluid_backups: vec![],
    }
    .build(|factory| {
        factory.add_process(ManualUiConfig { accesses: vec![] });
        // Optional: Impure Pile of {x}
        // Optional: Ilmenite Dust
        factory.add_process(FluidLowAlert(s("helium"), 16_000));
        factory.add_process(FluidLowAlert(s("benzene"), 16_000));
        ...
        factory.add_process(LowAlert::new(label("Ender Pearl"), 16));
        factory.add_process(LowAlert::new(label("Eye of Ender"), 4));
        factory.add_process(LowAlert::new(label("Bismuth Dust"), 16));
        factory.add_process(LowAlert::new(label("Lithium Dust"), 16));
        factory.add_process(LowAlert::new(label("Rock Salt Ore"), 16));
        factory.add_process(LowAlert::new(label("Cryolite Dust"), 16));
        factory.add_process(LowAlert::new(label("Saltpeter Dust"), 16));
        ...
        factory.add_storage(DrawerConfig {
            accesses: vec![InvAccess { client: s("c5"), addr: s("065"), bus_side: SOUTH, inv_side: WEST }],
            filters: vec![label("Raw Silicon Dust"), label("Calcium Dust"), label("Stone Dust"), label("Ashes")],
        });
        fn dust(x: &'static str) -> Filter { both(x, "gregtech:gt.metaitem.01") }
        ...
        for (fluid, client, bus_of_tank) in [
            ...
            ("fluid.coaltar", "c5", EachBusOfTank { addr: s("98c"), bus_side: EAST, tank_side: UP }),
            ("carbonmonoxide", "c5", EachBusOfTank { addr: s("e7e"), bus_side: WEST, tank_side: UP }),
            ("molten.potassium disulfate", "c5", EachBusOfTank { addr: s("d07"), bus_side: EAST, tank_side: SOUTH }),
            ("dye.chemical.dyered", "c5", EachBusOfTank { addr: s("d07"), bus_side: EAST, tank_side: UP }),
            ...
            ("rhodium salt solution", "c1", EachBusOfTank { addr: s("073"), bus_side: EAST, tank_side: NORTH }),
            ("rhodium filter cake solution", "c1", EachBusOfTank { addr: s("073"), bus_side: EAST, tank_side: UP }),
            ("ruthenium tetroxide solution", "c1", EachBusOfTank { addr: s("073"), bus_side: EAST, tank_side: WEST }),
            ("ruthenium tetroxide", "c1", EachBusOfTank { addr: s("073"), bus_side: EAST, tank_side: SOUTH }),
            ...
            ("rhodium sulfate solution", "c1", EachBusOfTank { addr: s("06d"), bus_side: WEST, tank_side: EAST }),
            ("molten.potassium", "c1", EachBusOfTank { addr: s("06d"), bus_side: WEST, tank_side: NORTH }),
            ("sodium formate", "c1", EachBusOfTank { addr: s("06d"), bus_side: WEST, tank_side: UP }),
            ("formic acid", "c1", EachBusOfTank { addr: s("06d"), bus_side: WEST, tank_side: SOUTH }),
            ...
            ("nitrofuel", "c2", EachBusOfTank { addr: s("9a6"), bus_side: SOUTH, tank_side: UP }),
            ...
            ("hot ruthenium tetroxide solution", "c3", EachBusOfTank { addr: s("324"), bus_side: EAST, tank_side: SOUTH }),
            ("steam", "c3", EachBusOfTank { addr: s("f94"), bus_side: NORTH, tank_side: UP }),
            ...
            ("benzene", "c5", EachBusOfTank { addr: s("890"), bus_side: WEST, tank_side: SOUTH }),
            ("platinum concentrate", "c1", EachBusOfTank { addr: s("2e3"), bus_side: NORTH, tank_side: EAST }),
            ("aqua regia", "c1", EachBusOfTank { addr: s("2e3"), bus_side: NORTH, tank_side: WEST }),
            ("acidic osmium solution", "c1", EachBusOfTank { addr: s("2e3"), bus_side: NORTH, tank_side: UP }),
            ("ammonium chloride", "c1", EachBusOfTank { addr: s("2e3"), bus_side: NORTH, tank_side: SOUTH }),
            ("osmium solution", "c1", EachBusOfTank { addr: s("b43"), bus_side: SOUTH, tank_side: NORTH }),
            ("acidic iridium solution", "c1", EachBusOfTank { addr: s("b43"), bus_side: SOUTH, tank_side: EAST }),
            ("calcium chloride", "c1", EachBusOfTank { addr: s("b43"), bus_side: SOUTH, tank_side: WEST }),
            ("rhodium sulfate", "c1", EachBusOfTank { addr: s("b43"), bus_side: SOUTH, tank_side: UP }),
        ...
        for access in [
            ...
            InvAccess { client: s("main"), addr: s("c47"), bus_side: NORTH, inv_side: UP }, // main
            InvAccess { client: s("cr"), addr: s("b20"), bus_side: EAST, inv_side: UP },   // cr
            InvAccess { client: s("c3"), addr: s("b5b"), bus_side: WEST, inv_side: SOUTH }, // chemicalBath
        ] {
        ...
        for (client, bus_of_tank) in [
            ...
            ("c5", EachBusOfTank { addr: s("890"), bus_side: WEST, tank_side: NORTH }), // electrolyzer
            ("c5", EachBusOfTank { addr: s("890"), bus_side: WEST, tank_side: UP }), // electrolyzer
            ("c3", EachBusOfTank { addr: s("f94"), bus_side: NORTH, tank_side: SOUTH }), // steamCracker-17
            ("main", EachBusOfTank { addr: s("2d4"), bus_side: DOWN, tank_side: UP }), // ICO-8
        ] {
        ...
        for (fluid, buckets, backup, client, bus_of_tank) in [
            ("lubricant", 16, 0, "c2", EachBusOfTank { addr: s("9a6"), bus_side: SOUTH, tank_side: NORTH }), // LCE-main
            ...
            ("lubricant", 16, 0, "c5", EachBusOfTank { addr: s("957"), bus_side: UP, tank_side: EAST }),     // LCE-c5
            ("oxygen", 16, 0, "c5", EachBusOfTank { addr: s("957"), bus_side: UP, tank_side: NORTH }),       // LCE-c5
            ("lubricant", 16, 0, "main", EachBusOfTank { addr: s("2d4"), bus_side: DOWN, tank_side: WEST }), // LCE-center
            ("oxygen", 16, 0, "main", EachBusOfTank { addr: s("2d4"), bus_side: DOWN, tank_side: SOUTH }),   // LCE-center
        ...
        factory.add_process(CraftingRobotConfig {
            ...
            recipes: (["Raw Silicon Dust", "Wood Pulp", "Salt", "Rock Salt"].into_iter())
                ...
                .chain(["Indium Dust", "Leach Residue Dust", "Ashes"].into_iter().map(|x| CraftingGridRecipe {
                    outputs: ignore_outputs(1.),
                    inputs: vec![CraftingGridInput::new(label!("Tiny Pile of {x}"), (0..9).collect())],
                    max_sets: 64,
                    non_consumables: vec![],
                }))
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            recipes: vec![
                FluidSlottedRecipe {
                    ...
                    inputs: vec![],
                    fluids: vec![FluidSlottedInput::new(s("dilutedsulfuricacid"), vec![(0, 3_000)]).extra_backup(256_000)],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: ignore_outputs(64.),
                ...
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("ic2distilledwater"), 256_000),
                    inputs: vec![],
                    fluids: vec![FluidSlottedInput::new(s("water"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("osmium solution"), 16_000),
                    inputs: vec![],
                    fluids: vec![FluidSlottedInput::new(s("acidic osmium solution"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("ruthenium tetroxide"), 16_000),
                    inputs: vec![],
                    fluids: vec![FluidSlottedInput::new(s("hot ruthenium tetroxide solution"), vec![(0, 9_000)])],
                    max_sets: 7,
                },
            ],
        });
        factory.add_process(FluidSlottedConfig {
            name: s("steamCracker-17"),
            input_slots: vec![],
            input_tanks: vec![vec![0]],
            accesses: vec![InvTankAccess {
                client: s("c3"),
                invs: vec![],
                tanks: vec![vec![EachBusOfTank { addr: s("f94"), bus_side: NORTH, tank_side: WEST }]],
            }],
            to_extract: None,
            fluid_extract: None,
            strict_priority: false,
            recipes: vec![FluidSlottedRecipe {
                outputs: FluidOutput::new(s("hot ruthenium tetroxide solution"), 16_000),
                inputs: vec![],
                fluids: vec![FluidSlottedInput::new(s("ruthenium tetroxide solution"), vec![(0, 1_000)])],
                max_sets: 16,
            }],
        });
        factory.add_process(FluidSlottedConfig {
            name: s("fluidHeater-1"),
            input_slots: vec![],
            input_tanks: vec![vec![0]],
            accesses: vec![InvTankAccess {
                client: s("c3"),
                invs: vec![],
                tanks: vec![vec![EachBusOfTank { addr: s("f94"), bus_side: NORTH, tank_side: DOWN }]],
            }],
            to_extract: None,
            fluid_extract: fluid_extract_slots(|_, slot| slot == 1),
            strict_priority: false,
            recipes: vec![FluidSlottedRecipe {
                outputs: FluidOutput::new(s("steam"), 64_000),
                inputs: vec![],
                fluids: vec![FluidSlottedInput::new(s("water"), vec![(0, 6)])],
                max_sets: 64,
            }],
        });
        factory.add_process(FluidSlottedConfig {
            ...
            recipes: vec![
                FluidSlottedRecipe {
                    outputs: ignore_outputs(64.),
                    inputs: vec![],
                    fluids: vec![FluidSlottedInput::new(s("molten.potassium"), vec![(0, 144)]).extra_backup(1)],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
        ...
        factory.add_process(FluidSlottedConfig {
            name: s("ballSolidifier-1"),
            input_slots: vec![],
            input_tanks: vec![vec![0]],
            accesses: vec![InvTankAccess {
                client: s("c5"),
                invs: vec![],
                tanks: vec![vec![EachBusOfTank { addr: s("d07"), bus_side: EAST, tank_side: DOWN }]],
            }],
            to_extract: None,
            fluid_extract: None,
            strict_priority: false,
            recipes: vec![
                FluidSlottedRecipe {
                    outputs: ignore_outputs(64.),
                    inputs: vec![],
                    fluids: vec![FluidSlottedInput::new(s("calcium chloride"), vec![(0, 1_000)]).extra_backup(1)],
                    max_sets: 128,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Red Dye"), 64),
                    inputs: vec![],
                    fluids: vec![FluidSlottedInput::new(s("dye.chemical.dyered"), vec![(0, 72)])],
                    max_sets: 64,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Ruthenium Tetroxide Dust"), 16),
                    inputs: vec![],
                    fluids: vec![FluidSlottedInput::new(s("ruthenium tetroxide"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
            ],
        });
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            accesses: vec![InvTankAccess {
                client: s("c3"),
                invs: vec![EachInvAccess { addr: s("b5b"), bus_side: WEST, inv_side: UP }],
                tanks: vec![vec![EachBusOfTank { addr: s("f1b"), bus_side: UP, tank_side: EAST }]],
            }],
            to_extract: None,
            fluid_extract: None,
            strict_priority: false,
            recipes: (["Sphalerite", "Antimony", "Bauxite", "Chalcopyrite", "Copper", "Roasted Nickel"].into_iter())
                ...
                .chain([
                    FluidSlottedRecipe {
                        ...
                        inputs: vec![MultiInvSlottedInput::new(label("Bio Chaff"), vec![(0, 0, 1)])],
                        fluids: vec![],
                        max_sets: 64,
                    },
                    FluidSlottedRecipe {
                        outputs: Output::new(label("Rutile Dust"), 64),
                        inputs: vec![MultiInvSlottedInput::new(label("Crushed Ilmenite Ore"), vec![(0, 0, 1)])],
                    ...
                    FluidSlottedRecipe {
                        ...
                        inputs: vec![MultiInvSlottedInput::new(label("Raw Carbon Fibre"), vec![(0, 0, 1)])],
                        fluids: vec![FluidSlottedInput::new(s("molten.epoxid"), vec![(0, 144)])],
                        max_sets: 64,
                    },
                ])
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            fluid_extract: None,
            strict_priority: false,
            recipes: (["Rock Salt", "Salt", "Arsenic"].into_iter())
                .map(|x| FluidSlottedRecipe {
                    outputs: Output::new(label!("Purified {x} Ore"), 16),
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            recipes: vec![
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Platinum Concentrate Cell"), 18),
                    inputs: vec![MultiInvSlottedInput::new(label("Empty Cell"), vec![(0, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("platinum concentrate"), vec![(0, 1_000)])],
                    max_sets: 64,
                },
                FluidSlottedRecipe {
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Benzene Cell"), 16),
                    inputs: vec![MultiInvSlottedInput::new(label("Empty Cell"), vec![(0, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("benzene"), vec![(0, 1_000)])],
                    max_sets: 32,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Ammonium Chloride Cell"), 16),
                    inputs: vec![MultiInvSlottedInput::new(label("Empty Cell"), vec![(0, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("ammonium chloride"), vec![(0, 1_000)])],
                    max_sets: 32,
                },
            ],
        });
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            recipes: vec![
                FluidSlottedRecipe {
                    outputs: Output::new(label("Palladium Salt Dust"), 64).not(),
                    inputs: vec![MultiInvSlottedInput::new(label("Palladium Metallic Powder Dust"), vec![(0, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("ammonia"), vec![(0, 1_000)])],
                    max_sets: 64,
                },
                FluidSlottedRecipe {
                ...
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("carbonmonoxide"), 64_000),
                    inputs: vec![MultiInvSlottedInput::new(label("Charcoal"), vec![(0, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("oxygen"), vec![(0, 1_000)])],
                    max_sets: 64,
                },
                FluidSlottedRecipe {
                ...
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("platinum concentrate"), 16_000),
                    inputs: vec![MultiInvSlottedInput::new(label("Purified Chalcopyrite Ore"), vec![(0, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("aqua regia"), vec![(0, 150)])],
                    max_sets: 64,
                },
                FluidSlottedRecipe {
                ...
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("formic acid"), 256_000),
                    inputs: vec![MultiInvSlottedInput::new(label("Sulfuric Acid Cell"), vec![(1, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("sodium formate"), vec![(0, 2_000)])],
                    max_sets: 64,
                },
                FluidSlottedRecipe {
                ...
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("methanol"), 64_000),
                    inputs: vec![MultiInvSlottedInput::new(label("Hydrogen Cell"), vec![(1, 0, 4)])],
                    fluids: vec![FluidSlottedInput::new(s("carbonmonoxide"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                ...
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("molten.plastic"), 128_000),
                ...
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("ammonium chloride"), 16_000),
                    inputs: vec![MultiInvSlottedInput::new(label("Hydrochloric Acid Cell"), vec![(1, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("ammonia"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("molten.silicone"), 256_000),
                    inputs: vec![
                ...
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("methane"), 256_000),
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Rhodium Nitrate Dust"), 16),
                    inputs: vec![MultiInvSlottedInput::new(label("Sodium Nitrate Dust"), vec![(0, 0, 5)])],
                    fluids: vec![FluidSlottedInput::new(s("rhodium salt solution"), vec![(0, 1_000)])],
                    max_sets: 12,
                },
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("nitrobenzene"), 768_000),
                    inputs: vec![
                ...
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("rhodium sulfate solution"), 16_000),
                    inputs: vec![MultiInvSlottedInput::new(label("Water Cell"), vec![(1, 0, 10)])],
                    fluids: vec![FluidSlottedInput::new(s("rhodium sulfate"), vec![(0, 11_000)])],
                    max_sets: 6,
                },
                FluidSlottedRecipe {
        ...
        factory.add_process(FluidSlottedConfig {
            name: s("EV-LCR-24"),
            input_slots: vec![(0..10).collect(), vec![0], vec![0], vec![0]],
            input_tanks: vec![vec![0]],
            accesses: vec![InvTankAccess {
                client: s("c2"),
                invs: vec![
            ...
            recipes: vec![
                FluidSlottedRecipe {
                    outputs: ignore_outputs(64.),
                    inputs: ((0..6).map(|i| MultiInvSlottedInput::new(label("Magnesiumchloride Dust"), vec![(0, i, 1)])))
                        .chain((6..10).map(|i| MultiInvSlottedInput::new(label("Sodium Dust"), vec![(0, i, 1)])))
                        .collect(),
                    fluids: vec![],
                    max_sets: 64,
                },
                FluidSlottedRecipe {
                    ...
                    inputs: vec![
                        ...
                        MultiInvSlottedInput::new(label("Water Cell"), vec![(2, 0, 1)]),
                    ],
                    fluids: vec![FluidSlottedInput::new(s("nitrogendioxide"), vec![(0, 2_000)]).extra_backup(1)],
                    max_sets: 64,
                },
                FluidSlottedRecipe {
                ...
                FluidSlottedRecipe {
                    ...
                    inputs: vec![MultiInvSlottedInput::new(label("Ammonia Cell"), vec![(1, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("oxygen"), vec![(0, 4_000)])],
                    max_sets: 32,
                },
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("aceticacid"), 256_000),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Carbon Dust"), vec![(0, 0, 2)]),
                        MultiInvSlottedInput::new(label("Oxygen Cell"), vec![(1, 0, 2)]),
                    ],
                    fluids: vec![FluidSlottedInput::new(s("hydrogen"), vec![(0, 4_000)])],
                    max_sets: 32,
                },
                ...
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("biodiesel"), 256_000),
                    inputs: vec![
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Platinum Dust"), 256),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Reprecipitated Platinum Dust"), vec![(0, 0, 4)]),
                        MultiInvSlottedInput::new(label("Calcium Dust"), vec![(0, 1, 1)]),
                    ],
                    fluids: vec![],
                    max_sets: 16,
                },
                ...
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("acetone"), 128_000),
                    inputs: vec![],
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            recipes: vec![
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Palladium Salt Dust"), 16),
                    inputs: vec![],
                    fluids: vec![FluidSlottedInput::new(s("palladium enriched ammonia"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Reprecipitated Rhodium Dust"), 16),
                    inputs: vec![],
                    fluids: vec![FluidSlottedInput::new(s("rhodium filter cake solution"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Palladium Dust"), 256),
                    inputs: vec![MultiInvSlottedInput::new(label("Reprecipitated Palladium Dust"), vec![(0, 0, 4)])],
                    fluids: vec![FluidSlottedInput::new(s("formic acid"), vec![(0, 4_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Rhodium Dust"), 256),
                    inputs: vec![MultiInvSlottedInput::new(label("Reprecipitated Rhodium Dust"), vec![(0, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("hydrochloricacid_gt5u"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Iridium Chloride Dust"), 16),
                    inputs: vec![MultiInvSlottedInput::new(label("Ammonium Chloride Cell"), vec![(1, 0, 3)])],
                    fluids: vec![FluidSlottedInput::new(s("acidic iridium solution"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("dye.chemical.dyered"), 16_000),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Red Dye"), vec![(0, 0, 1)]).allow_backup(),
                        MultiInvSlottedInput::new(dust("Salt"), vec![(0, 1, 2)]),
                    ],
                    fluids: vec![FluidSlottedInput::new(s("sulfuricacid"), vec![(0, 432)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Osmium Dust"), 256),
                    inputs: vec![MultiInvSlottedInput::new(label("Hydrochloric Acid Cell"), vec![(1, 0, 6)])],
                    fluids: vec![FluidSlottedInput::new(s("osmium solution"), vec![(0, 1_000)])],
                    max_sets: 10,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Ruthenium Dust"), 256),
                    inputs: vec![MultiInvSlottedInput::new(label("Ruthenium Tetroxide Dust"), vec![(0, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("hydrochloricacid_gt5u"), vec![(0, 6_000)])],
                    max_sets: 10,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Potassium Disulfate Dust"), 16),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Potassium Dust"), vec![(0, 0, 2)]),
                        MultiInvSlottedInput::new(label("Sulfur Dust"), vec![(0, 1, 2)]),
                    ],
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Platinum Salt Dust"), 16)
                        .and(Output::new(label("Reprecipitated Platinum Dust"), 16))
                        .and(FluidOutput::new(s("palladium enriched ammonia"), 16_000)),
                    inputs: vec![MultiInvSlottedInput::new(label("Platinum Concentrate Cell"), vec![(1, 0, 18)])],
                    fluids: vec![FluidSlottedInput::new(s("ammonium chloride"), vec![(0, 3_600)])],
                    max_sets: 3,
                },
            ],
        });
        factory.add_process(FluidSlottedConfig {
            ...
            accesses: vec![InvTankAccess {
                client: s("c5"),
                invs: vec![EachInvAccess { addr: s("64f"), bus_side: EAST, inv_side: UP }],
                tanks: vec![vec![EachBusOfTank { addr: s("d07"), bus_side: EAST, tank_side: WEST }]],
            }],
            to_extract: None,
            fluid_extract: None,
            strict_priority: false,
            recipes: vec![
                FluidSlottedRecipe {
                    outputs: ignore_outputs(64.),
                    inputs: vec![MultiInvSlottedInput::new(label("Zinc Sulfate Dust"), vec![(0, 0, 6)])],
                    fluids: vec![FluidSlottedInput::new(s("hydrogen"), vec![(0, 2_000)])],
                    max_sets: 10,
                },
                FluidSlottedRecipe {
                    outputs: ignore_outputs(64.),
                    inputs: vec![MultiInvSlottedInput::new(label("Sodium Sulfate Dust"), vec![(0, 0, 7)])],
                    fluids: vec![FluidSlottedInput::new(s("hydrogen"), vec![(0, 2_000)])],
                    max_sets: 9,
                },
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("sodium formate"), 256_000),
                    inputs: vec![MultiInvSlottedInput::new(label("Sodium Hydroxide Dust"), vec![(0, 0, 3)])],
                    fluids: vec![FluidSlottedInput::new(s("carbonmonoxide"), vec![(0, 1_000)])],
                    max_sets: 21,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Crude Rhodium Metal Dust"), 16),
                    inputs: vec![MultiInvSlottedInput::new(label("Zinc Dust"), vec![(0, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("rhodium sulfate solution"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("acidic iridium solution"), 16_000),
                    inputs: vec![MultiInvSlottedInput::new(label("Iridium Dioxide Dust"), vec![(0, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("hydrochloricacid_gt5u"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Iridium Dust"), 256),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Iridium Chloride Dust"), vec![(0, 0, 1)]),
                        MultiInvSlottedInput::new(label("Calcium Dust"), vec![(0, 1, 1)]),
                    ],
                    fluids: vec![],
                    max_sets: 16,
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Sodium Nitrate Dust"), 16),
                    inputs: vec![MultiInvSlottedInput::new(label("Sodium Dust"), vec![(0, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("nitricacid"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("ruthenium tetroxide solution"), 16_000),
                    inputs: vec![MultiInvSlottedInput::new(label("Sodium Ruthenate Dust"), vec![(0, 0, 6)])],
                    fluids: vec![FluidSlottedInput::new(s("chlorine"), vec![(0, 3_000)])],
                    max_sets: 10,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Platinum Residue Dust"), 16),
                    inputs: vec![MultiInvSlottedInput::new(label("Platinum Metallic Powder Dust"), vec![(0, 0, 9)])],
                    fluids: vec![FluidSlottedInput::new(s("aqua regia"), vec![(0, 9_000)])],
                    max_sets: 7,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Reprecipitated Palladium Dust"), 16),
                    inputs: vec![MultiInvSlottedInput::new(label("Palladium Metallic Powder Dust"), vec![(0, 0, 9)])],
                    fluids: vec![FluidSlottedInput::new(s("palladium enriched ammonia"), vec![(0, 9_000)])],
                    max_sets: 7,
                },
            ],
        });
        let ebf_n_recipes = |idx| {
            [
                FluidSlottedRecipe {
                    outputs: ignore_outputs(64.),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Ilmenite Dust"), vec![(idx, 0, 5)]),
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Rhodium Salt Dust"), 16),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Crude Rhodium Metal Dust"), vec![(idx, 0, 1)]),
                        MultiInvSlottedInput::new(dust("Salt"), vec![(idx, 1, 1)]),
                    ],
                    fluids: vec![FluidSlottedInput::new(s("chlorine"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Hot Talonite Ingot"), 16),
                    inputs: vec![MultiInvSlottedInput::new(label("Talonite Dust"), vec![(idx, 0, 1)])],
                    fluids: vec![],
                    max_sets: 8,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Hot Tantalloy-61 Ingot"), 16),
                    inputs: vec![MultiInvSlottedInput::new(label("Tantalloy-61 Dust"), vec![(idx, 0, 1)])],
                    fluids: vec![],
                    max_sets: 8,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Rarest Metal Residue Dust"), 16).and(Output::new(label("Sodium Ruthenate Dust"), 16)),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Leach Residue Dust"), vec![(idx, 0, 10)]),
                        MultiInvSlottedInput::new(label("Saltpeter Dust"), vec![(idx, 1, 10)]),
                    ],
                    fluids: vec![FluidSlottedInput::new(s("saltwater"), vec![(0, 1_000)])],
                    max_sets: 6,
                },
                FluidSlottedRecipe {
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Hot Grisium Ingot"), 16),
                    inputs: vec![MultiInvSlottedInput::new(label("Grisium Dust"), vec![(idx, 0, 1)])],
                    fluids: vec![],
                    max_sets: 1,
                },
            ]
        ...
        let ebf_11_recipes = |idx| {
            [
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("acidic osmium solution"), 16_000).and(Output::new(label("Iridium Metal Residue Dust"), 16)),
                    inputs: vec![MultiInvSlottedInput::new(label("Rarest Metal Residue Dust"), vec![(idx, 0, 2)])],
                    fluids: vec![FluidSlottedInput::new(s("hydrochloricacid_gt5u"), vec![(0, 500)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Leach Residue Dust"), 16).and(FluidOutput::new(s("rhodium sulfate"), 16_000)),
                    inputs: vec![MultiInvSlottedInput::new(label("Platinum Residue Dust"), vec![(idx, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("molten.potassium disulfate"), vec![(0, 360)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("sulfurdioxide"), 64_000).and(Output::new(label("Roasted Iron Dust"), 16)),
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Red Steel Ingot"), 16),
                    inputs: vec![MultiInvSlottedInput::new(label("Red Steel Dust"), vec![(idx, 0, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("oxygen"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            fluid_extract: None,
            strict_priority: false,
            recipes: (ebf_n_recipes(0).into_iter())
                .chain(ebf_11_recipes(0).into_iter())
                .chain([
                    // Circuit-12
                    FluidSlottedRecipe {
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            fluid_extract: None,
            strict_priority: false,
            recipes: (ebf_n_recipes(1).into_iter())
                .chain(ebf_11_recipes(1).into_iter())
                .chain([
                    // Circuit-1
                    FluidSlottedRecipe {
                    ...
                    FluidSlottedRecipe {
                        outputs: Output::new(label("Platinum Metallic Powder Dust"), 16),
                        inputs: vec![MultiInvSlottedInput::new(label("Refined Platinum Salt Dust"), vec![(0, 0, 1)])],
                        fluids: vec![],
                        max_sets: 16,
                    },
                    FluidSlottedRecipe {
                        outputs: Output::new(label("Iridium Dioxide Dust"), 16),
                        inputs: vec![MultiInvSlottedInput::new(label("Iridium Metal Residue Dust"), vec![(0, 0, 1)])],
                        fluids: vec![],
                        max_sets: 16,
                    },
                ])
        ...
        factory.add_process(FluidSlottedConfig {
            name: s("IV-EBF-3-22"),
            input_slots: vec![vec![0, 1, 2], vec![0, 1]],
            input_tanks: vec![vec![0]],
            accesses: vec![InvTankAccess {
                client: s("c5"),
                invs: vec![
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            recipes: vec![
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("nitrofuel"), 256_000),
                ...
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("dilutedsulfuricacid"), 64_000),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Sulfuric Acid Cell"), vec![(0, 5, 2)]),
                        MultiInvSlottedInput::new(label("Water Cell"), vec![(0, 6, 1)]),
                    ],
                    fluids: vec![],
                    max_sets: 32,
                },
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Red Steel Dust"), 16),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Sterling Silver Dust"), vec![(0, 5, 1)]),
                        MultiInvSlottedInput::new(label("Bismuth Bronze Dust"), vec![(0, 6, 1)]),
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Bismuth Bronze Dust"), 16),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Bismuth Dust"), vec![(0, 5, 1)]),
                        MultiInvSlottedInput::new(label("Brass Dust"), vec![(0, 6, 4)]),
                    ],
                    fluids: vec![],
                    max_sets: 8,
                },
        ...
        factory.add_process(SlottedConfig {
            name: s("EV-mixer-4"),
            accesses: vec![InvAccess { client: s("c5"), addr: s("a54"), bus_side: EAST, inv_side: NORTH }],
            input_slots: vec![5, 6],
            to_extract: None,
            strict_priority: false,
            recipes: vec![SlottedRecipe {
                outputs: Output::new(label("Sterling Silver Dust"), 16),
                inputs: vec![SlottedInput::new(label("Copper Dust"), vec![(5, 1)]), SlottedInput::new(label("Silver Dust"), vec![(6, 4)])],
                max_sets: 16,
            }],
        });
        factory.add_process(FluidSlottedConfig {
            ...
            accesses: vec![InvTankAccess {
                client: s("c5"),
                invs: vec![EachInvAccess { addr: s("373"), bus_side: WEST, inv_side: SOUTH }],
                tanks: vec![vec![EachBusOfTank { addr: s("373"), bus_side: EAST, tank_side: SOUTH }]],
            }],
            to_extract: None,
            fluid_extract: fluid_extract_all(),
            strict_priority: false,
            recipes: vec![
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("saltwater"), 64_000),
                    inputs: vec![MultiInvSlottedInput::new(dust("Salt"), vec![(0, 5, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("water"), vec![(0, 500)])],
                    max_sets: 64,
                },
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("aqua regia"), 256_000),
                    inputs: vec![MultiInvSlottedInput::new(label("Nitric Acid Cell"), vec![(0, 5, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("dilutedsulfuricacid"), vec![(0, 1_000)])],
                    max_sets: 64,
                },
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("rhodium salt solution"), 16_000),
                    inputs: vec![MultiInvSlottedInput::new(label("Rhodium Salt Dust"), vec![(0, 5, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("water"), vec![(0, 200)])],
                    max_sets: 64,
                },
                FluidSlottedRecipe {
                    outputs: FluidOutput::new(s("rhodium filter cake solution"), 16_000),
                    inputs: vec![MultiInvSlottedInput::new(label("Rhodium Filter Cake Dust"), vec![(0, 5, 1)])],
                    fluids: vec![FluidSlottedInput::new(s("water"), vec![(0, 1_000)])],
                    max_sets: 16,
                },
            ],
        ...
        factory.add_process(SlottedConfig {
            name: s("EV-mixer-12"),
            accesses: vec![InvAccess { client: s("c5"), addr: s("a54"), bus_side: EAST, inv_side: WEST }],
            input_slots: vec![5, 6],
            to_extract: None,
            strict_priority: false,
            recipes: vec![
                SlottedRecipe {
                    ...
                    inputs: vec![SlottedInput::new(label("Raw Silicon Dust"), vec![(5, 1)]), SlottedInput::new(label("Carbon Dust"), vec![(6, 1)])],
                    max_sets: 16,
                },
                SlottedRecipe {
                    outputs: Output::new(label("Tantalloy-60 Dust"), 16),
                    inputs: vec![SlottedInput::new(label("Tungsten Dust"), vec![(5, 2)]), SlottedInput::new(label("Tantalum Dust"), vec![(6, 23)])],
                    max_sets: 1,
                },
            ],
        });
        factory.add_process(SlottedConfig {
            name: s("EV-mixer-13"),
            accesses: vec![InvAccess { client: s("c5"), addr: s("a54"), bus_side: EAST, inv_side: UP }],
            input_slots: vec![5, 6, 7],
            to_extract: None,
            strict_priority: false,
            recipes: vec![SlottedRecipe {
                outputs: Output::new(label("Tantalloy-61 Dust"), 16),
                inputs: vec![
                    SlottedInput::new(label("Tantalloy-60 Dust"), vec![(5, 1)]),
                    SlottedInput::new(label("Titanium Dust"), vec![(6, 6)]),
                    SlottedInput::new(label("Yttrium Dust"), vec![(7, 4)]),
                ],
                max_sets: 2,
            }],
        });
        factory.add_process(FluidSlottedConfig {
            name: s("EV-mixer-B2"),
            input_slots: vec![vec![5, 6, 7, 8, 9]],
            input_tanks: vec![vec![0]],
            accesses: vec![InvTankAccess {
                client: s("c5"),
                invs: vec![EachInvAccess { addr: s("373"), bus_side: WEST, inv_side: UP }],
                tanks: vec![vec![EachBusOfTank { addr: s("373"), bus_side: EAST, tank_side: UP }]],
            }],
            to_extract: None,
            fluid_extract: None,
            strict_priority: false,
            recipes: vec![
                FluidSlottedRecipe {
                    outputs: Output::new(label("Grisium Dust"), 16),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Titanium Dust"), vec![(0, 5, 9)]),
                        MultiInvSlottedInput::new(label("Carbon Dust"), vec![(0, 6, 9)]),
                        MultiInvSlottedInput::new(label("Potassium Dust"), vec![(0, 7, 9)]),
                        MultiInvSlottedInput::new(label("Lithium Dust"), vec![(0, 8, 9)]),
                        MultiInvSlottedInput::new(label("Sulfur Dust"), vec![(0, 9, 9)]),
                    ],
                    fluids: vec![FluidSlottedInput::new(s("hydrogen"), vec![(0, 5_000)])],
                    max_sets: 1,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Talonite Dust"), 16),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Cobalt Dust"), vec![(0, 5, 4)]),
                        MultiInvSlottedInput::new(label("Chrome Dust"), vec![(0, 6, 3)]),
                        MultiInvSlottedInput::new(label("Phosphorus Dust"), vec![(0, 7, 2)]),
                        MultiInvSlottedInput::new(label("Molybdenum Dust"), vec![(0, 8, 1)]),
                    ],
                    fluids: vec![],
                    max_sets: 4,
                },
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            accesses: vec![InvTankAccess {
                ...
                tanks: vec![vec![EachBusOfTank { addr: s("890"), bus_side: WEST, tank_side: EAST }]],
            }],
            to_extract: None,
            fluid_extract: None,
            strict_priority: false,
            recipes: ([("carbondioxide", 1_000), ("solution.greenvitriol", 2_000), ("leadzincsolution", 8_000)].into_iter())
                .map(|(x, q)| FluidSlottedRecipe {
                    outputs: ignore_outputs(64.),
                    inputs: vec![],
                    fluids: vec![FluidSlottedInput::new(s(x), vec![(0, q)]).extra_backup(1)],
                    max_sets: (128_000 / q) as _,
                })
                .chain(
                    [
                        ("Magnesia Dust", (0..4).map(|_| 1).collect()),
                        ("Red Granite Dust", (0..6).map(|_| 1).collect()),
                        ("Potassium Feldspar Dust", (0..13).map(|_| 2).collect()),
                    ]
                    .into_iter()
                    .map(|(x, slots): (_, Vec<i32>)| FluidSlottedRecipe {
                        outputs: ignore_outputs(64.),
                        inputs: slots.into_iter().enumerate().map(|(i, q)| MultiInvSlottedInput::new(label(x), vec![(0, i, q)])).collect(),
                        fluids: vec![],
                        max_sets: 64,
                    }),
                )
                .chain([
                    ...
                    FluidSlottedRecipe {
                        outputs: ignore_outputs(64.),
                        inputs: vec![],
                        fluids: vec![FluidSlottedInput::new(s("carbonmonoxide"), vec![(0, 1_000)]).extra_backup(256_000)],
                        max_sets: 128,
                    },
                    FluidSlottedRecipe {
                        outputs: ignore_outputs(64.),
                        inputs: vec![],
                        fluids: vec![FluidSlottedInput::new(s("saltwater"), vec![(0, 1_000)]).extra_backup(256_000)],
                        max_sets: 128,
                    },
                    FluidSlottedRecipe {
                    ...
                    FluidSlottedRecipe {
                        outputs: FluidOutput::new(s("chlorine"), 256_000).and(Output::new(label("Potassium Dust"), 16)),
                        inputs: vec![MultiInvSlottedInput::new(dust("Rock Salt"), vec![(0, 0, 2)])],
                        fluids: vec![],
                        max_sets: 32,
                    },
                    FluidSlottedRecipe {
                        outputs: FluidOutput::new(s("chlorine"), 256_000).and(Output::new(label("Sodium Dust"), 16)),
                        inputs: vec![MultiInvSlottedInput::new(dust("Salt"), vec![(0, 0, 2)])],
                        fluids: vec![],
                        max_sets: 32,
                    },
                    FluidSlottedRecipe {
                        outputs: Output::new(label("Rutile Dust"), 16),
                        inputs: (0..13).map(|i| MultiInvSlottedInput::new(label("Bauxite Dust"), vec![(0, i, 3)])).collect(),
                        fluids: vec![],
                        max_sets: 21,
                    },
                    FluidSlottedRecipe {
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            recipes: vec![
                FluidSlottedRecipe {
                    outputs: Output::new(label("Wash Plant Casing"), 16),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Grisium Plate"), vec![(0, 5, 4)]),
                        MultiInvSlottedInput::new(label("Talonite Plate"), vec![(0, 6, 2)]),
                        MultiInvSlottedInput::new(label("Grisium Frame Box"), vec![(0, 7, 1)]),
                    ],
                    fluids: vec![],
                    max_sets: 16,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Structural Coke Oven Casing"), 16),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("Tantalloy-61 Rod"), vec![(0, 5, 4)]),
                        MultiInvSlottedInput::new(label("Tantalloy-61 Plate"), vec![(0, 6, 4)]),
                        MultiInvSlottedInput::new(label("Tantalloy-61 Frame Box"), vec![(0, 7, 1)]),
                    ],
                    fluids: vec![],
                    max_sets: 16,
                },
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Input Hatch (LV)"), 4),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("LV Machine Hull"), vec![(0, 5, 1)]),
                        MultiInvSlottedInput::new(label("Tank"), vec![(0, 6, 1)]),
                    ],
                    fluids: vec![FluidSlottedInput::new(s("molten.polybenzimidazole"), vec![(0, 9)])],
                    max_sets: 4,
                },
                FluidSlottedRecipe {
                    outputs: Output::new(label("Input Bus (HV)"), 4),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("HV Machine Hull"), vec![(0, 5, 1)]),
                        MultiInvSlottedInput::new(label("Iron Chest"), vec![(0, 6, 1)]),
                    ],
                    fluids: vec![FluidSlottedInput::new(s("molten.polybenzimidazole"), vec![(0, 36)])],
                    max_sets: 4,
                },
                FluidSlottedRecipe {
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            fluid_extract: None,
            strict_priority: false,
            recipes: [("LV", "Tin"), ("HV", "Gold"), ("EV", "Aluminium")]
                .into_iter()
                .map(|(v, c)| FluidSlottedRecipe {
                    outputs: Output::new(label!("{v} Machine Hull"), 4),
                    inputs: vec![
                        MultiInvSlottedInput::new(label!("{v} Machine Casing"), vec![(0, 5, 1)]),
                        MultiInvSlottedInput::new(label!("1x {c} Cable"), vec![(0, 6, 2)]),
                    ],
                ...
                .chain([
                    FluidSlottedRecipe {
                        outputs: Output::new(label("Raw Carbon Mesh"), 16),
                        inputs: vec![MultiInvSlottedInput::new(label("Raw Carbon Fibre"), vec![(0, 5, 2)])],
                        fluids: vec![],
                        max_sets: 8,
                    },
                    FluidSlottedRecipe {
                    ...
                    FluidSlottedRecipe {
                        outputs: Output::new(label("Output Bus (HV)"), 4),
                        inputs: vec![
                            MultiInvSlottedInput::new(label("HV Machine Hull"), vec![(0, 5, 1)]),
                            MultiInvSlottedInput::new(label("Iron Chest"), vec![(0, 6, 1)]),
                        ],
                    ...
                    FluidSlottedRecipe {
                        outputs: Output::new(label("Output Hatch (HV)"), 4),
                        inputs: vec![
                            MultiInvSlottedInput::new(label("HV Machine Hull"), vec![(0, 5, 1)]),
                            MultiInvSlottedInput::new(label("Iron Tank"), vec![(0, 6, 1)]),
                        ],
                        fluids: vec![FluidSlottedInput::new(s("molten.polybenzimidazole"), vec![(0, 36)])],
                        max_sets: 4,
                    },
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            recipes: vec![
                ...
                FluidSlottedRecipe {
                    outputs: Output::new(label("Maintenance Hatch"), 4),
                    inputs: vec![
                        MultiInvSlottedInput::new(label("LV Machine Hull"), vec![(0, 5, 1)]),
                        MultiInvSlottedInput::new(label("BrainTech Aerospace Advanced Reinforced Duct Tape FAL-84"), vec![(0, 6, 2)]),
                    ],
                    fluids: vec![FluidSlottedInput::new(s("advancedglue"), vec![(0, 200)])],
                    max_sets: 4,
                },
            ],
        });
        factory.add_process(FluidSlottedConfig {
            name: s("EV-assembler-4"),
            input_slots: vec![vec![5, 6, 7, 8, 9, 10]],
            input_tanks: vec![vec![0]],
            accesses: vec![InvTankAccess {
                client: s("c2"),
                invs: vec![EachInvAccess { addr: s("7b0"), bus_side: WEST, inv_side: NORTH }],
                tanks: vec![vec![EachBusOfTank { addr: s("7b0"), bus_side: EAST, tank_side: NORTH }]],
            }],
            to_extract: None,
            fluid_extract: None,
            strict_priority: false,
            recipes: (["Titanium", "Grisium", "Tantalloy-61"].into_iter())
                .map(|x| FluidSlottedRecipe {
                    outputs: Output::new(label!("{x} Frame Box"), 4),
                    inputs: vec![MultiInvSlottedInput::new(label!("{x} Rod"), vec![(0, 5, 4)])],
                    fluids: vec![],
                    max_sets: 8,
                })
                .chain(["Iron", "Gold", "Tungstensteel"].into_iter().map(|x| FluidSlottedRecipe {
                    ...
                    inputs: vec![
                        ...
                        MultiInvSlottedInput::new(label!("Double {x} Plate"), vec![(0, 6, 1)]),
                    ],
                    fluids: vec![FluidSlottedInput::new(s("molten.glass"), vec![(0, 144)])],
                    max_sets: 4,
                }))
                .chain([
                    FluidSlottedRecipe {
                        outputs: Output::new(label("BrainTech Aerospace Advanced Reinforced Duct Tape FAL-84"), 16),
                        inputs: vec![
                            MultiInvSlottedInput::new(label("Polybenzimidazole Plate"), vec![(0, 5, 1)]),
                            MultiInvSlottedInput::new(label("Raw Carbon Mesh"), vec![(0, 6, 1)]),
                        ],
                        fluids: vec![FluidSlottedInput::new(s("advancedglue"), vec![(0, 200)])],
                        max_sets: 8,
                    },
                    FluidSlottedRecipe {
                        outputs: Output::new(label("Iron Chest"), 4),
                        inputs: vec![
                            MultiInvSlottedInput::new(label("Chest"), vec![(0, 5, 1)]),
                            MultiInvSlottedInput::new(label("Double Iron Plate"), vec![(0, 6, 3)]),
                        ],
                        fluids: vec![],
                        max_sets: 4,
                    },
        ...
        factory.add_process(SlottedConfig {
            ...
            to_extract: None,
            strict_priority: false,
            recipes: ([("LV", "Steel"), ("HV", "Stainless Steel"), ("EV", "Titanium")].into_iter())
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            fluid_extract: None,
            strict_priority: false,
            recipes: ([(16, "Gold"), (16, "Tin"), (16, "Aluminium")].into_iter())
                ...
                .chain([("Stable Titanium Machine Casing", "Titanium")].into_iter().map(|(o, x)| FluidSlottedRecipe {
                    outputs: Output::new(label(o), 16),
                    inputs: vec![
                        MultiInvSlottedInput::new(label!("{x} Plate"), vec![(0, 5, 6)]),
                        MultiInvSlottedInput::new(label!("{x} Frame Box"), vec![(0, 6, 1)]),
                    ],
                    fluids: vec![],
                    max_sets: 16,
                }))
        ...
        factory.add_process(SlottedConfig {
            ...
            to_extract: None,
            strict_priority: false,
            recipes: (["Aluminium", "Stainless Steel", "Titanium"].into_iter())
                .map(|x| SlottedRecipe {
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            recipes: [
                ...
                (16, label("Enderpearl Plate"), label("Block of Enderpearl"), 19, 4),
            ]
            .into_iter()
        ...
        factory.add_process(FluidSlottedConfig {
            ...
            recipes: vec![
                ...
                FluidSlottedRecipe {
                    outputs: ignore_outputs(64.),
                    inputs: vec![MultiInvSlottedInput::new(label("Metallic Sludge Dust Residue Dust"), vec![(0, 0, 2)])],
                    fluids: vec![],
                    max_sets: 32,
                },
                FluidSlottedRecipe {
                    outputs: ignore_outputs(64.),
                    inputs: vec![MultiInvSlottedInput::new(label("Sludge Dust Residue Dust"), vec![(0, 0, 5)])],
                    fluids: vec![],
                    max_sets: 12,
                },
                FluidSlottedRecipe {
        ...
        factory.add_process(SlottedConfig {
            ...
            recipes: vec![
                ...
                SlottedRecipe {
                    outputs: Output::new(label("Block of Enderpearl"), 4),
                    inputs: vec![SlottedInput::new(label("Ender Pearl"), vec![(5, 9)])],
                    max_sets: 7,
                },
            ],
        });
        ...
        factory.add_process(SlottedConfig {
            ...
            to_extract: None,
            strict_priority: false,
            recipes: (["Iron", "Chrome", "Titanium", "Grisium", "Tantalloy-61"].into_iter())
                .map(|x| SlottedRecipe {
        ...
        factory.add_process(SlottedConfig {
            ...
            to_extract: None,
            strict_priority: false,
            recipes: (["Tin", "Gold", "Silver", "Gallium", "Electrum", "Red Alloy", "Plutonium 239", "Platinum", "Copper"].into_iter())
                .map(|x| SlottedRecipe {
        ...
        factory.add_process(SlottedConfig {
            name: s("redEngraver"),
            accesses: vec![InvAccess { client: s("cr"), addr: s("36a"), bus_side: WEST, inv_side: SOUTH }],
            input_slots: vec![5],
            to_extract: None,
            strict_priority: false,
            recipes: vec![
                SlottedRecipe {
                    outputs: Output::new(label("Integrated Logic Circuit (Wafer)"), 4),
                    inputs: vec![SlottedInput::new(label("Phosphorus doped Wafer"), vec![(5, 1)])],
                    max_sets: 1,
                },
                SlottedRecipe {
                    outputs: Output::new(label("Etched Low Voltage Wiring"), 16),
                    inputs: vec![SlottedInput::new(label("Red Alloy Foil"), vec![(5, 1)])],
                    max_sets: 16,
                },
            ],
        });
        factory.add_process(SlottedConfig {
            ...
            strict_priority: false,
            recipes: vec![SlottedRecipe {
                outputs: Output::new(label("Obsidian"), 256),
        ...
        factory.add_process(SlottedConfig {
            ...
            to_extract: None,
            strict_priority: false,
            recipes: (["Steel", "Aluminium", "Titanium", "Stainless Steel", "Grisium", "Talonite", "Tantalloy-61"].into_iter())
                .map(|x| SlottedRecipe {
        ...
        factory.add_process(SlottedConfig {
            name: s("bender-2"),
            accesses: vec![InvAccess { client: s("c5"), addr: s("065"), bus_side: SOUTH, inv_side: EAST }],
            input_slots: vec![5],
            to_extract: None,
            strict_priority: false,
        ...
        factory.add_process(SlottedConfig {
            ...
            to_extract: None,
            strict_priority: false,
            recipes: ["Gold", "Copper", "Gallium", "Electrum", "Aluminium", "Energetic Alloy", "Red Alloy"]
                .into_iter()
                .map(|x| SlottedRecipe {
        ...
        factory.add_process(SlottedConfig {
            ...
            to_extract: None,
            strict_priority: false,
            recipes: ([(16, "Tin"), (16, "Gold"), (16, "Copper"), (16, "HSS-G"), (16, "Aluminium")].into_iter())
        ...
        factory.add_process(SlottedConfig {
            name: s("sifter"),
            accesses: vec![InvAccess { client: s("c5"), addr: s("a54"), bus_side: EAST, inv_side: SOUTH }],
            input_slots: vec![5],
            to_extract: None,
            strict_priority: false,
            recipes: vec![
                SlottedRecipe {
                    outputs: Output::new(label("Refined Platinum Salt Dust"), 16),
                    inputs: vec![SlottedInput::new(label("Platinum Salt Dust"), vec![(5, 1)])],
                    max_sets: 16,
                },
                SlottedRecipe {
                    outputs: Output::new(label("Palladium Metallic Powder Dust"), 16),
                    inputs: vec![SlottedInput::new(label("Palladium Salt Dust"), vec![(5, 1)])],
                    max_sets: 16,
                },
                SlottedRecipe {
                    outputs: Output::new(label("Rhodium Filter Cake Dust"), 16),
                    inputs: vec![SlottedInput::new(label("Rhodium Nitrate Dust"), vec![(5, 1)])],
                    max_sets: 16,
                },
            ],
        });
        factory.add_process(SlottedConfig {
            ...
            strict_priority: false,
            recipes: vec![SlottedRecipe {
                outputs: FluidOutput::new(s("fluid.coaltar"), 64_000),
                inputs: (0..16).map(|i| SlottedInput::new(label("Charcoal"), vec![(i, 1)])).collect(),
                max_sets: 64,
            }],
        });
        factory.add_process(SlottedConfig {
        ...
        factory.add_process(BlockingFluidOutputConfig {
            ...
            outputs: vec![FluidOutput { fluid: s("water"), n_wanted: 256_000 }],
        });
        factory.add_process(BlockingFluidOutputConfig {
            accesses: vec![TankAccess { client: s("c4"), buses: vec![EachBusOfTank { addr: s("4c5"), bus_side: NORTH, tank_side: SOUTH }] }],
            outputs: vec![FluidOutput { fluid: s("benzene"), n_wanted: 32_000 }],
        })
    })
}
